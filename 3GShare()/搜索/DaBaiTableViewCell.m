...
- (void)layoutSubviews {
    ...
    self.titlefir.frame = CGRectMake(textX + 10, padding, textWidth, 28);
    self.subtitle.frame = CGRectMake(textX + 10, CGRectGetMaxY(self.titlefir.frame), textWidth, 20);
    self.name.frame = CGRectMake(textX + 10, CGRectGetMaxY(self.subtitle.frame) + 5, textWidth, 20);
    self.time.frame = CGRectMake(textX + 10, CGRectGetMaxY(self.name.frame) + 3, textWidth, 18);
